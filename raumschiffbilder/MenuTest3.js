...
var alleRaumschiffTypen = new Array("SHIP1", "SHIP2", "SHIP3", "SHIP4", "SHIP5", "SHIP6", "SHIP7");	
...
function berechneAbstandundWinkel(x,y, bild_breite){
	x -= bild_breite/2; // zentriert
	y -= bild_breite/2; // zentriert
	...
	abstand *= feldgroesse/bild_breite; 
...
function drawFlugzeugImage(bild_breite) {
		var canvasZeichnen = document.getElementById('canvasZeichnen');
		var contextZeichnen = canvasZeichnen.getContext('2d');	 
				contextZeichnen.strokeStyle = "rgb(0, 0, 0)";
				contextZeichnen.strokeRect (0, 0, bild_breite , bild_breite);
						
		  var img = new Image();
		  //img.src = 'raumschiffb1.jpg';
		  //img.src = 'raumschiffC1.jpg';
		  //img.src = 'raumschiffC.png';
		  img.src = 'Raumschiff2.png';
		  //img.src = 'Raumschiff3.png';
		  //img.src = 'Raumschiff4.png';
		  //img.src = 'Raumschiff5.png';
		  
		  img.onload = function(){
		  		var image_breite = img.naturalWidth ;
					var image_hoehe = img.naturalHeight ;	
		    contextZeichnen.drawImage(img, 0, 0, image_breite, image_hoehe, 0, 0, bild_breite, bild_breite);
		  }
}
